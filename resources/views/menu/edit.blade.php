        ...
        <div class="col-6">
            ...
            <div class="card card-body">
                <form action="/menu/{{ $menu->id }}" method="post" enctype="multipart/form-data"> 
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" required name="descMenu" required placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">
                        {{ old('descMenu', $menu->descMenu) }}
                        </textarea> 
                    ...
                    <div class="input-group"> 
                        <button class="btn btn-primary btn-sm rounded me-1" type="submit">Update</button>
                    </div>
                </form>
            </div>
        </div>
